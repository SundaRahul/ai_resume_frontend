...
function EducationForm() {
  ...
  // Initialize educationalList from resumeInfo once on component mount
  useEffect(() => {
  ...
  const onSave = () => {
    ...
    GlobalApi.UpdateResumeDetail(params.Resume_id, data)
      .then(() => {
        setLoading(false);
  ...
  // Only update resumeInfo when educationalList changes
  useEffect(() => {
    if (
