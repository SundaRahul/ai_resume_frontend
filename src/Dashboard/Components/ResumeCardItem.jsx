...
// function ResumeCardItem({resume,index}) {
//   return (
//     <Link  to={'/dashboard/resume/'+resume.documentId+"/edit"}>
//         <div className="mx-3 p-14 bg-gradient-to-b from-green-300 from-10% via-sky-200  to-green-400  flex justify-center h-[280px]
//         items-center border-primary rounded-lg hover:scale-105 transition-all hover:shadow-md shadow-primary">
//             {/* <Notebook/> */}
//             <img src="./cv.png" width={80} height={80} />
//         </div>
